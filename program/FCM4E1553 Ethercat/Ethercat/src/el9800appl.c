...
void APPL_InputMapping(UINT16* pData)
{
   ...
   for (j = 0; j < sTxPDOassign.u16SubIndex0; j++)
   {
      ...
      /* TxPDO 1 */
      case 0x1A00:
         *pTmpData++ = SWAPWORD(((UINT16 *) &DIInputs0x6000)[1]);
         break;
      }
   }
...
void APPL_OutputMapping(UINT16* pData)
{
    ...
    for (j = 0; j < sRxPDOassign.u16SubIndex0; j++)
    {
        ...
        /* RxPDO 2 */
        case 0x1600:
            ((UINT16 *) &DOOutputs0x7000)[1] = SWAPWORD(*pTmpData++);
				    ((UINT16 *) &DOOutputs0x7000)[2] = SWAPWORD(*pTmpData++);
            break;
        }
    }
...
void APPL_Application(void)
{
	...
	//led	
    LED_1                        = DOOutputs0x7000.LED1;
    LED_2                        = DOOutputs0x7000.LED2;
    LED_3                        = DOOutputs0x7000.LED3;
    LED_4                        = DOOutputs0x7000.LED4;
    LED_5                        = DOOutputs0x7000.LED5;
    LED_7                        = DOOutputs0x7000.LED7;
    LED_6                        = DOOutputs0x7000.LED6;
    LED_8                        = DOOutputs0x7000.LED8;
//按键
    DIInputs0x6000.Switch1    = SWITCH_1;
    DIInputs0x6000.Switch2    = SWITCH_2;
    DIInputs0x6000.Switch3    = SWITCH_3;
    DIInputs0x6000.Switch4    = SWITCH_4;
    DIInputs0x6000.Switch5    = SWITCH_5;
    DIInputs0x6000.Switch6    = SWITCH_6;
    DIInputs0x6000.Switch7    = SWITCH_7;
    DIInputs0x6000.Switch8    = SWITCH_8;
...
UINT8 ReadObject0x1802(UINT16 index, UINT8 subindex, UINT32 dataSize, UINT16 MBXMEM * pData, UINT8 bCompleteAccess) {
 if(bCompleteAccess)
    ...
    if(subindex == 0)
    {
        *pData = TxPDOParameter0x1802.u16SubIndex0;
    }
    else if(subindex == 6)
    {
    ...
    else if(subindex == 7)
    {
        ...
        *pu8Data = TxPDOParameter0x1802.TxPDOState;
    }
    else if(subindex == 9)
    {
        /*min size is one Byte*/
        ...
        *pu8Data = TxPDOParameter0x1802.TxPDOToggle;
    }
    else
